...
/***  
    ...
    Note: I am assuming type 'C' for above case
***/
...
const accountTypeChecker = (accountBalanceHistory) => {
    ...
    for (var i = 0; i < accountBalanceHistory.length - 1; i++) {
        if (!diff) {
            ...
            console.log('Your account type is B (amount will be either increasing or decreasing)');
            result = 'B';
            ...
            console.log('Your account type is A (amount will be decreasing by variable amount)');
            result = 'A';
        } else {
            //the balance amount increases by varying amounts each month
            console.log('Your account type is C (amount will be increasing by variable amount)');
            result = 'C'; 
        }
    }
